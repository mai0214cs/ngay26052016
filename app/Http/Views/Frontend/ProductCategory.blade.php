        ...
        <aside class="span3">
         ...
         <!--  Best Seller -->  
          <div class="sidewidt">
            ...
            <ul class="bestseller">
              <li>
                <img width="50" height="50" src="/library/img/prodcut-40x40.jpg" alt="product" title="product">
          ...
          <div class="flexslider" id="mainslider">
            <ul class="slides">
              <li>
                <img src="/library/img/product1.jpg" alt="" />
              </li>
              <li>
                <img src="/library/img/product2.jpg" alt="" />
              </li>
            </ul>
          </div>
          </div>
